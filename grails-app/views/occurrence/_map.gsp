...
<asset:script type="text/javascript">
    ...
    function addQueryLayer(redraw) {
        ...
        var avhLayer = L.tileLayer.wms(MAP_VAR.mappingUrl + "/mapping/wms/reflect" + MAP_VAR.query.replace('dh4', 'dh9') + MAP_VAR.additionalFqs, {
            layers: 'ALA:occurrences',
            format: 'image/png',
            transparent: true,
            bgcolor:"0x000000",
        ...
        MAP_VAR.layerControl.addOverlay(mainLayer, "${shortName} Occurrences");
        MAP_VAR.map.addLayer(mainLayer);
        MAP_VAR.currentLayers.push(mainLayer);

        MAP_VAR.layerControl.addOverlay(avhLayer, "AVH Occurrences");
        MAP_VAR.map.addLayer(avhLayer);
        MAP_VAR.currentLayers.push(avhLayer);
