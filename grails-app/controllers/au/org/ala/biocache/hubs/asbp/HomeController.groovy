...
class HomeController extends au.org.ala.biocache.hubs.HomeController {
    ...
    def advancedSearch(AsbpAdvancedSearchParams requestParams) {
        HomeController.log.debug "ASBP Home controller advancedSearch page"
    ...
    /**
     * Get list of states for AU and NZ (used by ASBP)
     */
    Map loadStateValues() {
